  ...
  return [
    {
      ...
      description: "3 unused add-ons cost ~4,100 tokens every request",
      installType: "builtin",
      status: "curated_v1",
      defaultOn: true,
      installed: true,
    ...
    },
    {
      ...
      description: "Compresses command output before Claude reads it",
    ...
    },
    {
      ...
      description: "Claude explains less, codes the same",
    ...
    },
    {
      ...
      description: "Nudges Claude to build only what you asked for",
      installType: "claude_plugin",
      status: "curated_v1",
      defaultOn: false,
      installed: false,
